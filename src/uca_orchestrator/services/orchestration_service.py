...
class OrchestrationService:
    ...
    async def _persist_artifacts(self, *, use_case_id: uuid.UUID, state: UseCaseState) -> None:
        # Artifacts are generated by the orchestrator node and then persisted here.
        generated = state.get("generated_artifacts") or state.get("_generated_artifacts")  # backwards compat
